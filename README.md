...
-User Authentication: Users can create accounts with name, email, password, and role. Secure login with hashed passwords. Student (borrow/search), Librarian (manage books/loans), Admin (manage users/settings). Change password, view borrowing history.
